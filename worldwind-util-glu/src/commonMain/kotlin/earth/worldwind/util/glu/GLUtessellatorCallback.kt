...
interface GLUtessellatorCallback {
	 ...
	 * <PRE>
	 * void myCombine(double[] coords, Any[] data,
	 * float[] weight, Any[] outData)
	 * {
	 ...
	 */
	fun combine(coords: DoubleArray, data: Array<Any?>, weight: FloatArray, outData: Array<Any?>)
	 ...
	 * [gluErrorString][GLU.gluErrorString] call.
	 * <BR></BR>
