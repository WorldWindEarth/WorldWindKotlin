...
class TextureQuadExampleActivity : GeneralGlobeActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        aboutBoxText = "Demonstrates how to stretch texture quad"
        ...
        wwd.selectDragDetector.callback = object : SelectDragCallback {
            ...
            override fun onRenderableMoved(renderable: Renderable, fromPosition: Position, toPosition: Position) {
                ...
                val textureQuad = renderable.getUserProperty<TextureQuad>(TEXTURE_QUAD_REF)
    ...
    companion object {
        ...
        private fun createStretchableTextureQuad(
            bottomLeft: Location, bottomRight: Location, topRight: Location, topLeft: Location, imageSource: ImageSource
        ): List<Renderable> {
            val textureQuad = TextureQuad(bottomLeft, bottomRight, topRight, topLeft, ShapeAttributes().apply {
