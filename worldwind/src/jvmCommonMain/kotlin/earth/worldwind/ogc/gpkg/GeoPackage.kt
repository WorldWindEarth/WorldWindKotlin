...
open class GeoPackage(val pathName: String, val isReadOnly: Boolean = true) {
    ...
    suspend fun getExtension(tableName: String, columnName: String, extensionName: String): GpkgExtension? = withContext(Dispatchers.IO) {
    ...
    suspend fun readTilesDataSize(tableName: String) = withContext(Dispatchers.IO) {
        connectionSource.getReadOnlyConnection("").use { connection ->
    ...
    suspend fun clearContent(tableName: String) = withContext(Dispatchers.IO) {
        ...
        tileUserDataDao[tableName]?.deleteBuilder()?.delete()
        griddedTileDao.deleteBuilder().apply {
    ...
    suspend fun deleteContent(tableName: String): Unit = withContext(Dispatchers.IO) {
        ...
        griddedCoverageDao.deleteBuilder().apply {
