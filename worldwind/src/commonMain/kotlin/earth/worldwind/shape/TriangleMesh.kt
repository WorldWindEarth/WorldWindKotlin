...
open class TriangleMesh(
    ...
    override fun computeMeshPoints(rc: RenderContext): FloatArray {
        ...
        val meshPoints = FloatArray(positions.size * 3)
        val pt = Vec3()
    ...
    companion object {
        ...
        fun split(
            ...
            for (i in 0..indices.size) {
                if ((i == indices.size) || ((splitPositions.size > MAX_POSITIONS - 3) && splitIndices.size % 3 == 0)) {
