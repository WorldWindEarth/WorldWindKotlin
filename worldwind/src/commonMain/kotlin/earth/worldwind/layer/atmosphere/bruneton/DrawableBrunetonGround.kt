...
internal class DrawableBrunetonGround : Drawable {
    ...
    override fun draw(dc: DrawContext) {
        ...
        //   1..4    = shadow cascades 0..3 (bound by applyShadowReceiverUniforms)
        //   5       = transmittance LUT
        //   6       = irradiance LUT
        //   7       = scattering LUT
        ...
        // Bind cascade textures to units 1..4 and upload cascade matrices for the
        // SECONDARY pass's [shadowSunVisibility] sampler. No-op (uploads `applyShadow=0`)
        ...
        for (idx in 0 until dc.drawableTerrainCount) {
            ...
            // Camera-relative twin for the shadow lookup - differenced in double here, as the
            // cascades are fitted camera-relative.
            program.loadShadowVertexOrigin(
