 ...
 * the name of the feature. If a [Snippet] is not supplied, the first two lines of the [Feature.description] are used.
 ...
 */
@Serializable
data class Snippet(@XmlValue(true) val value: String, val maxLines: Int = 2) {
