...
// The int/float/double typealiases Karakum emits at the top have been moved to
// C5RenTypes.kt — modern Kotlin disallows non-external declarations inside a
// `@file:JsModule` file, and those aliases are the only such declarations here.
...
external class Point : JsAny {
    ...
    fun getX(): Double
    fun getY(): Double
    fun setLocation(x1: Double, y1: Double): Unit
     ...
     * @returns {void}
     */
    fun shift(x: Double, y: Double): Unit
 ...
 *
 */
external class Rectangle2D : JsAny {
    constructor ()
    ...
    fun grow(size: int): JsAny?
    fun grow(h: int, v: int): JsAny?
    fun stroke(context: CanvasRenderingContext2D): Unit
    fun fill(context: CanvasRenderingContext2D): Unit
     ...
     * @returns
     */
    fun toSVGElement(stroke: String?, strokeWidth: Double, fill: String?): String
}
 ...
 *
 */
external class Font : JsAny {
    constructor (s: String, type: Double, size: Double)
    ...
    companion object {
        ...
        val BOLD: Double
        val ITALIC: Double
        fun getTypeString(type: Double): String
        fun getTypeInt(type: String): Double
    }
}
 ...
 */
external object AffiliationColors : JsAny {
...
external class Color : JsAny {
    ...
    companion object {
         ...
         */
        val BLUE: Color
        fun makeColor(r: Double, g: Double, b: Double): Color
    }
}
 ...
 *
 */
external class ErrorLogger : JsAny {
    ...
    companion object {
         ...
         * @return {@link String}
         */
        fun getStackTrace(error: JsAny): String
         ...
         * @deprecated
         */
        fun CleanupOldFiles(DaysOld: Double): Unit
         ...
         */
        fun Entering(sourceClass: String, sourceMethod: String, param1: JsAny?): Unit
         ...
         */
        fun Entering(sourceClass: String, sourceMethod: String, params: JsArray<JsAny?>): Unit
         ...
         */
        fun Exiting(sourceClass: String, sourceMethod: String, result: JsAny?): Unit
        ...
        fun LogMessage(
            ...
            message: String,
            lvl: LogLevel,
            params: JsArray<JsAny?>,
            showMessageBox: Boolean
        ): Unit

        fun LogException(sourceClass: String, sourceMethod: String, exc: JsAny): Unit
        fun LogException(sourceClass: String, sourceMethod: String, exc: JsAny, showMessageBox: Boolean): Unit
        fun LogException(sourceClass: String, sourceMethod: String, exc: JsAny, lvl: LogLevel): Unit
        fun LogException(
            sourceClass: String,
            sourceMethod: String,
            exc: JsAny,
        ...
        fun PrintList(list: JsArray<JsAny?>): String
        fun PrintObjectMap(map: JsMap): String
        fun PrintStringMap(map: JsMap): String
    }
}
 ...
 */
external class MilStdAttributes : JsAny {
    ...
    companion object {
         ...
         */
        fun GetModifierList(): JsArray<JsString>
        fun GetAttributesList(symbolID: String): JsArray<JsString>
 ...
 */
external class Modifiers : JsAny {
    ...
    companion object {
         ...
         * @return Array<string>
         */
        fun GetSymbolCodeModifiersList(): JsArray<JsString>

        /**
         * Returns an Arraylist of the modifier names for units
         * @return Array<string>
         */
        fun GetUnitModifierList(): JsArray<JsString>

        /**
         * Returns an Arraylist of the modifiers for Control Measures
         * @return Array<string>
         */
        fun GetControlMeasureModifierList(): JsArray<JsString>
 ...
 *
 */
external class DrawRules : JsAny {
    ...
    companion object {
         ...
         * Orientation: Not applicable
         */
        val CIRCULAR1: Double

        /**
         * Anchor Points: This symbol requires one anchor point that defines an
         * object at a JsAny? grid location. This coordinate, which pinpoints the
 ...
 *
 */
external class MODrawRules : JsAny {
 ...
 */
external class GENCLookup : JsAny {
    fun isReady(): Boolean
    fun get3CharCode(id: Double): String
...
external class MSInfo : JsAny {
    ...
    fun getDrawRule(): Double
    fun getSymbolSet(): Double
    fun getEntityCode(): Double
    fun getBasicSymbolID(): String
    fun getMinPointCount(): Double
    fun getMaxPointCount(): Double
    fun getModifiers(): JsArray<JsString>

    companion object {
        fun parseSymbolSetName(symbolID: String): String
        fun parseSymbolSetName(ss: String, version: Double): String
    }
}
...
external class MSLookup : JsAny {
     ...
     * @return
     */
    fun getMSLInfo(basicID: String, version: Double): MSInfo?
     ...
     * @return
     */
    fun getIDList(version: Double): JsArray<JsString>
...
external class SVGLookup : JsAny {
    fun isReady(): Boolean
    fun getSVGLInfo(id: String, version: Double): SVGInfo?
    fun getSVGOctagon(): SVGInfo?
    fun addCustomSymbol(svgInfo: SVGInfo, version: Double): Boolean
    ...
    companion object {
        ...
        fun getAllKeys(): JsArray<JsString>
    }
}

external interface SymbolDimensionInfo : JsAny {
    /**
     * The x value the image should be centered on or the "anchor point".
     * @return {@link Integer}
     */
    fun getSymbolCenterX(): Double

    /**
     * The y value the image should be centered on or the "anchor point".
     * @return {@link Integer}
     */
    fun getSymbolCenterY(): Double
 ...
 *
 */
external class SymbolUtilities : JsAny {
    ...
    companion object {
         ...
         * @return string
         */
        fun getDateLabel(date: JsAny): String
...
external interface SettingsEventListener : JsAny {
 ...
 *
 */
external class RendererSettings : JsAny {
 ...
 *
 */
external class SymbolID : JsAny {

    companion object {
        val Version_2525D: Double
        val Version_2525Dch1: Double

        /**
         * @deprecated withdrawn from standard
         */
        val Version_APP6Dch2: Double
        val Version_2525E: Double
        val StandardIdentity_Context_Reality: Double
        val StandardIdentity_Context_Exercise: Double
        val StandardIdentity_Context_Simulation: Double
        val StandardIdentity_Affiliation_Pending: Double
        val StandardIdentity_Affiliation_Unknown: Double
        val StandardIdentity_Affiliation_AssumedFriend: Double
        val StandardIdentity_Affiliation_Friend: Double
        val StandardIdentity_Affiliation_Neutral: Double
        val StandardIdentity_Affiliation_Suspect_Joker: Double
        val StandardIdentity_Affiliation_Hostile_Faker: Double
        val SymbolSet_Unknown: Double
        val SymbolSet_Air: Double
        val SymbolSet_AirMissile: Double
        val SymbolSet_Space: Double
        val SymbolSet_SpaceMissile: Double
        val SymbolSet_LandUnit: Double
        val SymbolSet_LandCivilianUnit_Organization: Double
        val SymbolSet_LandEquipment: Double
        val SymbolSet_LandInstallation: Double
        val SymbolSet_ControlMeasure: Double
        val SymbolSet_DismountedIndividuals: Double
        val SymbolSet_SeaSurface: Double
        val SymbolSet_SeaSubsurface: Double
        val SymbolSet_MineWarfare: Double
        val SymbolSet_Activities: Double
        val SymbolSet_Atmospheric: Double
        val SymbolSet_Oceanographic: Double
        val SymbolSet_MeteorologicalSpace: Double
        val SymbolSet_SignalsIntelligence: Double
        val SymbolSet_SignalsIntelligence_Space: Double
        val SymbolSet_SignalsIntelligence_Air: Double
        val SymbolSet_SignalsIntelligence_Land: Double
        val SymbolSet_SignalsIntelligence_SeaSurface: Double
        val SymbolSet_SignalsIntelligence_SeaSubsurface: Double
        val SymbolSet_CyberSpace: Double
        val SymbolSet_InvalidSymbol: Double
        val SymbolSet_VersionExtensionFlag: Double
        val Status_Present: Double
        val Status_Planned_Anticipated_Suspect: Double
        val Status_Present_FullyCapable: Double
        val Status_Present_Damaged: Double
        val Status_Present_Destroyed: Double
        val Status_Present_FullToCapacity: Double
        val Status_Present_VersionExtensionFlag: Double
        val HQTFD_Unknown: Double
        val HQTFD_FeintDummy: Double
        val HQTFD_Headquarters: Double
        val HQTFD_FeintDummy_Headquarters: Double
        val HQTFD_TaskForce: Double
        val HQTFD_FeintDummy_TaskForce: Double
        val HQTFD_TaskForce_Headquarters: Double
        val HQTFD_FeintDummy_TaskForce_Headquarters: Double
        val HQTFD_VersionExtensionFlag: Double
        val Echelon_Unknown: Double
        val Echelon_Team_Crew: Double
        val Echelon_Squad: Double
        val Echelon_Section: Double
        val Echelon_Platoon_Detachment: Double
        val Echelon_Company_Battery_Troop: Double
        val Echelon_Battalion_Squadron: Double
        val Echelon_Regiment_Group: Double
        val Echelon_Brigade: Double
        val Echelon_VersionExtensionFlag: Double
        val Echelon_Division: Double
        val Echelon_Corps_MEF: Double
        val Echelon_Army: Double
        val Echelon_ArmyGroup_Front: Double
        val Echelon_Region_Theater: Double
        val Echelon_Region_Command: Double
        val Echelon_VersionExtensionFlag2: Double
        val Mobility_Unknown: Double
        val Mobility_WheeledLimitedCrossCountry: Double
        val Mobility_WheeledCrossCountry: Double
        val Mobility_Tracked: Double
        val Mobility_Wheeled_Tracked: Double
        val Mobility_Towed: Double
        val Mobility_Rail: Double
        val Mobility_PackAnimals: Double
        val Mobility_OverSnow: Double
        val Mobility_Sled: Double
        val Mobility_Barge: Double
        val Mobility_Amphibious: Double
        val Mobility_ShortTowedArray: Double
        val Mobility_LongTowedArray: Double
        val Leadership_Individual: Double
         ...
         */
        fun getVersion(symbolID: String): Double
         ...
         */
        fun setVersion(symbolID: String, ver: Double): String
         ...
         */
        fun getStandardIdentity(symbolID: String): Double
         ...
         * @return updated 30 character string symbol ID
         */
        fun setStandardIdentity(symbolID: String, si: Double): String
         ...
         * @return number
         */
        fun getContext(symbolID: String): Double
         ...
         */
        fun setContext(symbolID: String, context: Double): String
         ...
         */
        fun getAffiliation(symbolID: String): Double
         ...
         * @return string updated Symbol ID.
         */
        fun setAffiliation(symbolID: String, affiliation: Double): String
         ...
         */
        fun getSymbolSet(symbolID: String): Double
         ...
         * @return string updated Symbol ID.
         */
        fun setSymbolSet(symbolID: String, ss: Double): String
         ...
         */
        fun getStatus(symbolID: String): Double
         ...
         * @return string updated Symbol ID.
         */
        fun setStatus(symbolID: String, status: Double): String
         ...
         */
        fun getHQTFD(symbolID: String): Double
         ...
         * @return string updated Symbol ID.
         */
        fun setHQTFD(symbolID: String, HQTFD: Double): String
         ...
         * @return number
         */
        fun getAmplifierDescriptor(symbolID: String): Double
         ...
         * @return string
         */
        fun setAmplifierDescriptor(symbolID: String, ad: Double): String
         ...
         * @return number
         */
        fun getEntityCode(symbolID: String): Double
         ...
         * @return string
         */
        fun setEntityCode(symbolID: String, entityCode: Double): String
         ...
         * @return number
         */
        fun getEntity(symbolID: String): Double
         ...
         * @return number
         */
        fun getEntityType(symbolID: String): Double
         ...
         * @return number
         */
        fun getEntitySubtype(symbolID: String): Double
         ...
         * @return number
         */
        fun getModifier1(symbolID: String): Double
         ...
         * @return string
         */
        fun setModifier1(symbolID: String, mod1: Double): String
         ...
         * @return number
         */
        fun getCommonModifier1(symbolID: String): Double
         ...
         * @return string
         */
        fun setCommonModifier1(symbolID: String, mod1I: Double): String
         ...
         * @return number
         */
        fun getModifier2(symbolID: String): Double
         ...
         * @return string
         */
        fun setModifier2(symbolID: String, mod1: Double): String
         ...
         * @return number
         */
        fun getCommonModifier2(symbolID: String): Double
         ...
         * @return string
         */
        fun setCommonModifier2(symbolID: String, mod1I: Double): String
         ...
         * @return number
         */
        fun getCountryCode(symbolID: String): Double
...
external class AffineTransform : JsAny {
    constructor ()
}

external class PathIterator : JsAny {
    constructor (tx: AffineTransform?)

    fun getPoints(): JsArray<POINT2>
    fun currentSegment(coords: JsArray<JsNumber>): int
    ...
    fun setPathIterator(pts: JsArray<POINT2>): Unit
 ...
 *
 */
external interface Shape : JsAny {
...
external class Rectangle : Shape {
     ...
     * @param y
     */
    fun shiftTL(x: Double, y: Double): Unit
     ...
     */
    fun shiftBR(x: Double, y: Double): Unit
    ...
    companion object {
        val OUT_LEFT: JsAny? /* type isn't declared */
        val OUT_TOP: JsAny? /* type isn't declared */
        val OUT_RIGHT: JsAny? /* type isn't declared */
        val OUT_BOTTOM: JsAny? /* type isn't declared */
    }
}

external class Polygon : JsAny {
    constructor ()
     ...
     * @param npoints
     */
    constructor (xpoints: JsArray<JsNumber>, ypoints: JsArray<JsNumber>, npoints: int)

    var npoints: int
    var xpoints: JsArray<JsNumber>
    var ypoints: JsArray<JsNumber>
 ...
 *
 */
external interface Stroke : JsAny {
...
external class BasicStroke : Stroke {
     ...
     */
    fun getDashArray(): JsArray<JsNumber>?
...
external class FontRenderContext : JsAny {
    constructor ()
}

external class TextLayout : JsAny {
    constructor (s: String, font: Font, frc: FontRenderContext)

    var _font: Font
    var _str: String
    fun getOutline(tx: AffineTransform?): Shape
    fun getPixelBounds(frc: FontRenderContext, x: float, y: float): JsAny?
    fun getBounds(): Rectangle
}

external class TexturePaint : JsAny {
 ...
 */
open external class ShapeInfo : JsAny {
    constructor ()
    ...
    fun getPolylines(): JsArray<JsArray<Point2D>>
    fun setPolylines(value: JsArray<JsArray<Point2D>>): Unit
...
external class DistanceUnit : JsAny {
 ...
 */
external class MilStdSymbol : JsAny {
    /**
     *
    ...
    constructor (
        symbolID: String,
        uniqueID: String?,
        Coordinates: JsArray<Point2D>,
        modifiers: JsMap?,
        keepUnitRatio: Boolean = definedExternally
    )

    var _LineWidth: Double
     ...
     * @return {@link Map}
     */
    fun getModifierMap(): JsMap

    /**
     * sets the modifier map for the symbol
     * @param modifiers {@link Map}
     */
    fun setModifierMap(modifiers: JsMap): Unit
    ...
    fun setModifier_AM_AN_X(modifier: String, value: Double, index: int): Unit
    fun getModifiers_AM_AN_X(modifier: String): JsArray<JsNumber>?
    fun setModifiers_AM_AN_X(modifier: String, modifiers: JsArray<JsNumber>): Unit
     ...
     */
    fun setCoordinates(value: JsArray<Point2D>): Unit

    /**
     *
     * @return {@link ArrayList}
     */
    fun getCoordinates(): JsArray<Point2D>
     ...
     */
    fun setModifierShapes(value: JsArray<ShapeInfo>): Unit
     ...
     * @return {@link ArrayList}
     */
    fun getModifierShapes(): JsArray<ShapeInfo>
     ...
     */
    fun setSymbolShapes(value: JsArray<ShapeInfo>): Unit
     ...
     * @return {@link ArrayList}
     */
    fun getSymbolShapes(): JsArray<ShapeInfo>
 ...
 *
 */
external interface IPointConversion : JsAny {
...
external class FontMetrics : JsAny {
...
external class Graphics2D : JsAny {
    constructor ()
...
external class Modifier2 : JsAny {
    constructor ()

    fun get_TextPath(): JsArray<POINT2>
    fun set_TextPath(value: JsArray<POINT2>): Unit
    ...
    companion object {
         ...
         */
        fun GetIntegralTextShapes(tg: TGLight, g2d: Graphics2D, shapes: JsArray<Shape2>): Unit
...
external class TGLight : JsAny {
    constructor ()

    var LatLongs: JsArray<POINT2>
    fun get_LatLongs(): JsArray<POINT2>
    fun set_LatLongs(value: JsArray<POINT2>): Unit
    var Pixels: JsArray<POINT2>
    fun get_Pixels(): JsArray<POINT2>
    fun set_Pixels(value: JsArray<POINT2>): Unit
    var modifiers: JsArray<Modifier2>
    fun get_Modifiers(): JsArray<Modifier2>
    fun set_Modifiers(value: JsArray<Modifier2>): Unit
    var tp: TexturePaint
 ...
 *
 */
external class clsRenderer : JsAny {
    ...
    companion object {
        ...
        fun render_GE(
            tg: TGLight,
            shapeInfos: JsArray<ShapeInfo>,
            modifierShapeInfos: JsArray<ShapeInfo>,
            converter: IPointConversion,
            clipArea: JsArray<Point2D>
        ): Unit
         ...
         * @param clipBounds the pixels based clip bounds
         */
        fun render(mss: MilStdSymbol, converter: IPointConversion, clipBounds: JsArray<Point2D>?): Unit
...
external class RendererUtilities : JsAny {

    companion object {
        fun imgToBase64String(img: HTMLCanvasElement): Promise<JsString>
        ...
        fun getData(path: String): Promise<JsAny?>
    }
}
 ...
 */
external class MilStdIconRenderer : JsAny {
    fun isReady(): Boolean
     ...
     */
    fun CanRender(symbolID: String, attributes: JsMap): Boolean
    fun RenderSVG(
        symbolID: String,
        modifiers: JsMap,
        attributes: JsMap
 ...
 *
 */
external class WebRenderer : JsAny {
    /**
    ...
    companion object {
        val OUTPUT_FORMAT_KML: JsAny? /* type isn't declared */

        /**
         * @deprecated
         */
        val OUTPUT_FORMAT_JSON: JsAny? /* type isn't declared */
        val OUTPUT_FORMAT_GEOJSON: JsAny? /* type isn't declared */
        val OUTPUT_FORMAT_GEOSVG: JsAny? /* type isn't declared */
         ...
         * @deprecated
         */
        fun getSinglePointByteArray(symbolID: String): JsAny?
         ...
         */
        fun getRectangleCorners(endpoints: String, width: Double): String
    }
}
 ...
 */
external fun initialize(location: String = definedExternally): Promise<JsAny?>
