...
/**
	 ...
	 */
fun Entering(sourceClass: String, sourceMethod: String, params: Array<Any?>): Unit
/**
	 * Log a method return.
	 * <p>
...
fun LogMessage(sourceClass: String, sourceMethod: String, message: String, lvl: LogLevel, showMessageBox: Boolean): Unit
fun LogMessage(sourceClass: String, sourceMethod: String, message: String, lvl: LogLevel, param1: Any?, showMessageBox: Boolean): Unit
fun LogMessage(sourceClass: String, sourceMethod: String, message: String, lvl: LogLevel, params: Array<Any?>, showMessageBox: Boolean): Unit
...
fun LogException(sourceClass: String, sourceMethod: String, exc: Error, lvl: LogLevel, showMessageBox: Boolean): Unit
fun PrintList(list: Array<Any?>): String
fun PrintObjectMap(map: Map<String, Any?>): String
fun PrintStringMap(map: Map<String, String>): String
}
}
...
companion object {
fun loadData(location: String = definedExternally): Promise<Unit>
...
/**
	 ...
	 */
fun setGraphicPreferredAffiliationColors(friendlyGraphicLineColor: Color, hostileGraphicLineColor: Color, neutralGraphicLineColor: Color, unknownGraphicLineColor: Color, friendlyGraphicFillColor: Color, hostileGraphicFillColor: Color, neutralGraphicFillColor: Color, unknownGraphicFillColor: Color): Unit
/**
	 ...
	 */
fun setUnitPreferredAffiliationColors(friendlyUnitLineColor: Color, hostileUnitLineColor: Color, neutralUnitLineColor: Color, unknownUnitLineColor: Color, friendlyUnitFillColor: Color, hostileUnitFillColor: Color, neutralUnitFillColor: Color, unknownUnitFillColor: Color): Unit
companion object {
/**
...
fun currentSegment(coords: Array<Double>): int
...
/**
	 ...
	 * @param npoints
	 */
constructor (xpoints: Array<int>, ypoints: Array<int>, npoints: int)
var npoints: int
...
constructor (width: float, cap: int, join: int, miterlimit: float, dash: Array<float>?, dash_phase: float)
var width: float
var join: int
var cap: int
...
/**
	 ...
	 */
override fun createStrokedShape(poly: Shape): Shape
...
/**
	 ...
	 */
val CAP_SQUARE: int
fun GetInteriorPoints(pLinePoints: Array<POINT2>, vblCounter: int, lineType: int, dist: double): Array<POINT2>
}
}
...
/**
	 ...
	 * modifiers
	 */
constructor (symbolID: String, uniqueID: String, Coordinates: Array<Point2D>, modifiers: Map<String, String>, keepUnitRatio: Boolean = definedExternally)
...
/**
	 ...
	 * @return {@link Map}
	 */
fun getModifierMap(): Map<String, String>
/**
	 * sets the modifier map for the symbol
	 * @param modifiers {@link Map}
	 */
fun setModifierMap(modifiers: Map<String, String>): Unit
/**
...
fun getModifiers_AM_AN_X(modifier: String): Array<Double>?
fun setModifiers_AM_AN_X(modifier: String, modifiers: Array<Double>): Unit
/**
	 *
...
/**
	 ...
	 */
fun CanRender(symbolID: String, attributes: Map<String, String>): Boolean
fun RenderSVG(symbolID: String, modifiers: Map<String, String>, attributes: Map<String, String>): SVGSymbolInfo?
...
/**
	 ...
	 */
fun RenderSymbol(id: String, name: String, description: String, symbolCode: String, controlPoints: String, altitudeMode: String, scale: double, bbox: String, modifiers: Map<String, String>, attributes: Map<String, String>, format: int): String
/**
	 ...
	 */
fun RenderSymbol2D(id: String, name: String, description: String, symbolCode: String, controlPoints: String, pixelWidth: int, pixelHeight: int, bbox: String, modifiers: Map<String, String>, attributes: Map<String, String>, format: int): String
/**
	 ...
	 * @return MilStdSymbol
	 */
fun RenderMultiPointAsMilStdSymbol(id: String, name: String, description: String, symbolCode: String, controlPoints: String, altitudeMode: String, scale: double, bbox: String, modifiers: Map<String, String>, attributes: Map<String, String>): MilStdSymbol
/**
	 * Given a symbol code meant for a single point symbol, returns the
	 * anchor point at which to display that image based off the image returned
	 * from the URL of the SinglePointServer.
...
// Following part was added manually
...
external class PointConverter3D(controlLong: double, controlLat: double, scale: double) : IPointConversion {
