...
external class PathIterator {
    ...
    fun currentSegment(coords: Array<Number>): int
...
external class Modifier2 {
    ...
    fun get_TextPath(): Array<POINT2>
    fun set_TextPath(value: Array<POINT2>): Unit
...
external class clsRenderer {
    ...
    companion object {
         ...
         * @return
         */
        fun intersectsClipArea(tg: TGLight, converter: IPointConversion, clipArea: Array<Point2D>): Boolean
         ...
         */
        fun renderWithPolylines(mss: MilStdSymbol, converter: IPointConversion, clipArea: Array<Point2D>?): Unit
